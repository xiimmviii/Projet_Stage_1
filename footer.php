<footer class="bg-secondary">
    ...
    <div class="row copyrow text-light">
        <div class="col-12 copyright m-3"> Copyright © 2019 SOCIETE | <a href="mentionslegales" class="copyright-a">Mentions légales</a> | <a href="CGU" class="copyright-a">CGU</a></div>
    </div>
